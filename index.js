...
//Mongoose 
const uri = "mongodb+srv://piyush:piyush@cluster0.so4bq.mongodb.net/garageDB?retryWrites=true&w=majority";
...
app.post("/getCards" ,async function(req,res){
     let payload = req.body.payload.trim();
      let search = await JobCard.find({vehicleNumber: {$regex : RegExp('^'+payload+'.*','i')}});
